...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Client Login' link to open the login/registration dialog/page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/nav/div/div/div[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill only the full name field with a new customer name, then submit the registration form.
        frame = context.pages[-1]
        # Input text
