...
async function main() {
  ...
  const products = [
    ...
    { name: 'Penta 6A 1-Way Switch', category: 'Electrical', subcategory: 'Switches', description: 'Standard polycarbonate 6 Amp switch. White finish.', price: 45, unit: 'piece', brandId: anchor.id, rating: 4, stockCount: 500, imageUrl: '/uploads/anchor_penta_switch.png' },
